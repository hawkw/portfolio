...
module Jekyll
  class Vimeo < Liquid::Tag
    ...
    def render(context)
      %(<div class="vimeo"><iframe width="#{@@width}" height="#{@@height}" src="http://player.vimeo.com/video/#{@id}" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen wmode="transparent"></iframe></div>)
    end
  end
end
